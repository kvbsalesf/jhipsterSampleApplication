...
public class LocationResourceIntTest {
    ...
    private static final String DEFAULT_ASD = "AAAAAAAAAA";
    private static final String UPDATED_ASD = "BBBBBBBBBB";
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getAsd()).isEqualTo(DEFAULT_ASD);
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getAsd()).isEqualTo(UPDATED_ASD);
